          ...
          <div className="border-4 border-dashed border-gray-200 rounded-lg p-8">
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Du er logget ind som administrator. Her kan du administrere
                restauranten.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-burgundy-light p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Administrer alle reservationer
                  </p>
                </div>
              ...
              <div className="flex">
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    <strong>Note:</strong> Dette er en demo admin side. I en
                    rigtig applikation ville der være funktioner til at
                    administrere reservationer, menu, brugere osv.
                  </p>
                </div>
              </div>
            </div>
