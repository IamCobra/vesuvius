...
function FacebookIcon({ className = "w-5 h-5" }: IconProps) {
  return (
...
function TwitterIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function ClockIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function SocialIcon({
  ...
  const icon = iconMap[platform.toLowerCase()] || iconMap.facebook;
...
export function ContactIcon({
  ...
  return iconMap[type] || iconMap.location;
}
