...
export function FreshIngredientsIcon({ className = "w-8 h-8" }: { className?: string }) {
  return (
...
export function FastDeliveryIcon({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
...
// Feature Icon Mapper
export function FeatureIcon({ icon, className = "w-8 h-8 text-orange-600" }: { icon: string; className?: string }) {
  switch (icon) {
    case "fresh-ingredients":
      return <FreshIngredientsIcon className={className} />;
    case "fast-delivery":
      return <FastDeliveryIcon className={className} />;
    case "made-with-love":
...
// Social Icon Mapper
export function SocialIcon({ platform, href, className = "w-5 h-5" }: { platform: string; href: string; className?: string }) {
  const IconComponent = {
